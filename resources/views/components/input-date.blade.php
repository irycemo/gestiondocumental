...
>
    <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-500 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 sm:text-sm">
