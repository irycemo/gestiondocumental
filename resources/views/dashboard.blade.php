...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <div class="p-4 bg-white rounded-2xl divide-y">
                ...
                @forelse ($entries as $entrie)
                    ...
                    <div class="flex justify-between items-center ">
                        ...
                        <div class="mb-2">
                            <p>Orignen: {{ $entrie->origen->name }}</p>
                            <p>Fecha de termino: {{ $entrie->fecha_termino }}</p>
                        </div>

                        <a href="{{ route('entries.show', $entrie->id) }}" class="px-2 py-1 bg-green-500 text-white rounded-full">Ver</a>
            ...
            <a href="{{ route('entries.index') }}" class="px-2 py-1 bg-blue-500 text-white rounded-full float-right mt-2">Ver todas</a>
        ...
        <div>
            ...
            <div class="p-4 bg-white rounded-2xl divide-y">
                ...
                @forelse ($trackings as $tracking)
                    ...
                    <div class="flex justify-between items-center ">
                        ...
                        <div class="mb-2">
                            <p>Oficio de entrada: {{ $tracking->entrie->numero_oficio }}</p>
                            <p>Fecha de respuesta: {{ $tracking->fecha_respuesta }}</p>
                        </div>
            ...
            <a href="{{ route('tracking') }}" class="px-2 py-1 bg-blue-500 text-white rounded-full float-right mt-2">Ver todos</a>
        ...
        <div>
            ...
            <div class="p-4 bg-white rounded-2xl divide-y">
                ...
                @forelse ($conclusions as $conclusion)
                    ...
                    <div class="flex justify-between items-center ">
                        ...
                        <div class="mb-2">
                            <p>Oficio de entrada: {{ $conclusion->entrie->numero_oficio }}</p>
                        </div>
            ...
            <a href="{{ route('conclusions') }}" class="px-2 py-1 bg-blue-500 text-white rounded-full float-right mt-2">Ver todos</a>
