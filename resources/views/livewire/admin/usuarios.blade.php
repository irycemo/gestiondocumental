                        ...
                        <x-table.cell>
                            ...
                            <p class="mt-2">
                                ...
                                <div class="flex items-center justify-center lg:justify-start">
                                    ...
                                    <span class="text-sm text-gray-900 dark:text-gray-200 ml-4">{{ $usuario->name }}</span>
    ...
    <x-dialog-modal wire:model="modal">
        ...
        <x-slot name="content">
            ...
            <div class="flex flex-col md:flex-row justify-between gap-3 mb-3">
                ...
                <x-input-group for="modelo_editar.oficina_id" label="Oficina" :error="$errors->first('modelo_editar.oficina_id')" class="">

                    <x-input-select id="modelo_editar.oficina_id" wire:model="modelo_editar.oficina_id" class="">
